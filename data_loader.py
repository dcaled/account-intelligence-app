...
def load_accounts() -> pd.DataFrame:
    ...
    # Null handling — fill missing staleness with the observed max (worst case, data-driven)
    ...
    df["has_transcript"] = df["call_transcript_summary"].notna() & df["call_transcript_summary"].str.strip().ne("")
...
if __name__ == "__main__":
    ...
    print(df[["account_name", "seat_utilization", "arr_uplift", "expansion_signal", "contraction_signal"]].head(10))
